(function () {
  ...
  window.adroll_seg_eid = "CKYZGSE62RE7JPLITMCC23";
  ...
  var cm_urls = ["/cm/r/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/b/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/x/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/l/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/o/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/g/out?advertisable=FYTZRQUEVVGS7EWCIOE64A&google_nid=adroll4"];
...
(function() {
  ...
  if (window === window.top && ua.indexOf('safari') !== -1 && ua.indexOf('chrome') === -1 && ua.indexOf('crios') === -1) {
    ...
    b.src = '//d.adroll.com/bounce/pre/FYTZRQUEVVGS7EWCIOE64A/MNBMU5UBV5A6DJOSTXTI32/?d=' + encodeURIComponent('//s.adroll.com/j/bounce.js');
...
rtb.innerHTML = ["/cm/b/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/g/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/index/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/n/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/o/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/outbrain/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/pubmatic/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/r/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/taboola/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/triplelift/out?advertisable=FYTZRQUEVVGS7EWCIOE64A","/cm/x/out?advertisable=FYTZRQUEVVGS7EWCIOE64A"].reduce(function (acc, cmURL) {
...
(function(){
  if (__adroll.consent_allowed(__adroll.consent_networks.linkedin)) {
    if (__adroll._has_global('adroll_segments')) {
      ...
      if (__adroll._global('adroll_segments') === '94f55aa5') {
        ...
        conversion_tag.setAttribute('src', 'https://px.ads.linkedin.com/collect/?pid=362788&conversionId=1679658&fmt=gif');

        document.body.appendChild(conversion_tag);
      }


      if (__adroll._global('adroll_segments') === '65fd19f7') {
        var conversion_tag = document.createElement("img");
        ...
        conversion_tag.setAttribute('style', 'display:none;');
        conversion_tag.setAttribute('alt', '');
        conversion_tag.setAttribute('src', 'https://px.ads.linkedin.com/collect/?pid=362788&conversionId=1679650&fmt=gif');
      ...
      try {
          (function(){
  if (__adroll.consent_allowed('linkedin')) {
    _linkedin_data_partner_id = "362788";
    ...
    fbq('init', '777423575708744');
    fbq('set', 'autoConfig', 'false', '777423575708744');
    __adroll.fb=true;

    var __fbcd = {segment_eid: "CKYZGSE62RE7JPLITMCC23"};
    ...
    var __fbcd = {event: "EventSegment", segment_eid: "CKYZGSE62RE7JPLITMCC23"};
    for (var prop in __adroll.get_external_data()){
        __fbcd['ar_' + prop] = __adroll.get_external_data()[prop];
    }
  ...
  if (typeof __adroll.set_pixel_cookie != 'undefined') {__adroll.set_pixel_cookie(adroll_adv_id, adroll_pix_id, "CKYZGSE62RE7JPLITMCC23");}
}());
